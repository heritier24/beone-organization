  ...
  >
    <div class="sidebar-inner px-4 pt-3">
      ...
      <ul class="nav flex-column pt-3 pt-md-0">
        <li class="nav-item">
          <a href="#" class="nav-link d-flex align-items-center">
            <span class="sidebar-icon">
              <img
                src="assets1/img/brand/light.svg"
                height="20"
                width="20"
                alt="Volt Logo"
              />
            </span>
            <span class="mt-1 ms-1 sidebar-text">BeOne Organization</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a href="/what-we-do" class="nav-link">
            <span class="sidebar-icon">
              <svg
                class="icon icon-xs me-2"
                fill="currentColor"
            ...
            <span class="sidebar-text">What We Do</span>
          </a>
        </li>
        ...
        <li class="nav-item">
          <a href="/clients-trusted-us-admin" class="nav-link">
            <span class="sidebar-icon">
              <svg
                class="icon icon-xs me-2"
                fill="currentColor"
            ...
            <span class="sidebar-text">Clients Trusted Us</span>
          </a>
        </li>
        <li class="nav-item">
          <a href="/testimonials-admin" class="nav-link">
            <span class="sidebar-icon">
              <svg
                class="icon icon-xs me-2"
                fill="currentColor"
